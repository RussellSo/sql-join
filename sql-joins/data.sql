...
--2. SELECT first_name, last_name, COUNT(vehicles) FROM owners JOIN vehicles ON owners.id = vehicles.owner_id GROUP BY first_name, last_name ORDER BY first_name
--3. SELECT first_name, last_name, AVG(price) AS average_price, COUNT(vehicles) FROM owners JOIN vehicles ON owners.id = vehicles.owner_id GROUP BY first_name, last_name HAVING AVG(price) > 10000 AND COUNT(vehicles) > 1 ORDER BY first_name DESC
